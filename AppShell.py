...
class AppShell(Pmw.MegaWidget):        
    ...
    def toggleBalloon(self):
        if self.toggleBalloonVar.get():
            self.__balloon.configure(state = 'balloon')
        else:
            self.__balloon.configure(state = 'none')
    ...
    def __createMenuBar(self):
        ...
        self.menuBar.addmenu('File', 'File commands and Exit')
    ...
    def __createMessageBar(self):
        ...
        self.entry = self.createcomponent('entry',
                                            ...
                                            Entry,
                                            (frame,))
        self.entry.pack(side=LEFT, expand=NO, fill=NONE)
        ...
        self.unitsDisplay = self.createcomponent('unitslabel',
                                                 (), None,
                                                 Label, (frame,),
                                                 text='Units: mm')
        self.unitsDisplay.pack(side=RIGHT, expand=NO, fill=NONE)
